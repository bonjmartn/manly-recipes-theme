...
class social_widget_footer extends WP_Widget {
  ...
  public function form( $instance ) {
    $title = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Follow Us', 'manly-recipes' );
    $facebook = ! empty( $instance['facebook'] ) ? $instance['facebook'] : __( '', 'manly-recipes' );
    $twitter = ! empty( $instance['twitter'] ) ? $instance['twitter'] : __( '', 'manly-recipes' );
    $pinterest = ! empty( $instance['pinterest'] ) ? $instance['pinterest'] : __( '', 'manly-recipes' );
    $instagram = ! empty( $instance['instagram'] ) ? $instance['instagram'] : __( '', 'manly-recipes' );
    $googleplus = ! empty( $instance['googleplus'] ) ? $instance['googleplus'] : __( '', 'manly-recipes' );
    $yelp = ! empty( $instance['yelp'] ) ? $instance['yelp'] : __( '', 'manly-recipes' );
    ...
    <p>
    <label for="<?php echo $this->get_field_id('twitter_field'); ?>"><?php _e('Enter the URL for your Twitter profile', 'manly-recipes'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('pinterest_field'); ?>"><?php _e('Enter the URL for your Pinterest page', 'manly-recipes'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('instagram_field'); ?>"><?php _e('Enter the URL for your Instagram profile', 'manly-recipes'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('googleplus_field'); ?>"><?php _e('Enter the URL for your Google Plus profile', 'manly-recipes'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('yelp_field'); ?>"><?php _e('Enter the URL for your Yelp page', 'manly-recipes'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('youtube_field'); ?>"><?php _e('Enter the URL for your YouTube page', 'manly-recipes'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('linkedin_field'); ?>"><?php _e('Enter the URL for your LinkedIn profile', 'manly-recipes'); ?></label>
